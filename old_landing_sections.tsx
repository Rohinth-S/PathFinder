...
export function HeroSection({ onPressGoogle }: HeroProps) {
  return (
    <SectionReveal style={{ minHeight: 700, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 24, paddingVertical: 80, backgroundColor: UI.surfaceInverse }}>
      ...
      {/* Small top label */}
      <StaggerItem index={1}>
        <SectionLabel color="rgba(255,255,255,0.4)" style={{ marginBottom: 40 }}>PATHFINDER ┬À BETA</SectionLabel>
      </StaggerItem>
...
export function ProblemSection() {
  return (
    <SectionReveal style={[s.sectionPy16, { backgroundColor: '#F9F4EB' }]}>
      ...
      <StaggerItem index={2}><Text style={s.body}>People jump between LinkedIn, Reddit, YouTube, blogs, and AI assistants for important decisions. Every platform shows a different fragment ÔÇö achievements, opinions, stories ÔÇö but never the whole journey.</Text></StaggerItem>
      <StaggerItem index={3}>
...
// ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
//  3. COMPARISON (Fragmented ÔåÆ Unified)
//  Horizontal scroll of fragment cards ÔåÆ "+" ÔåÆ unified card
// ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    ...
    <SectionReveal style={[s.sectionPy16, { backgroundColor: '#F6F2EC' }]}>
      ...
      <StaggerItem index={3}>
        <Text style={[s.body, { marginBottom: 40 }]}>
          By identifying hidden patterns across thousands of similar milestones, our engine synthesizes a unique narrative strategy tailored to your specific context ÔÇö turning fragmented data into a unified, actionable insight.
        </Text>
      </StaggerItem>
      ...
      <View style={{ alignItems: 'center', zIndex: 1 }}>
        ...
        <StaggerItem index={2}>
          <Text style={[s.body, { marginBottom: 32, color: L.navySoft, textAlign: 'center', maxWidth: '90%' }]}>
            People hesitate to share failures or unconventional decisions for fear of judgment, especially on traditional professional networks. PathFinder encourages honest storytelling; verification confirms experiences are genuine ÔÇö not that someone is "successful."
          </Text>
        </StaggerItem>
        <StaggerItem index={3}>
...
function GraphMotif() {
  ...
  const palette = {
    center:     '#4A3728',   // Deep espresso brown ÔÇö warm, rich, premium
    centerRing: '#F8EDE6',   // Warm cream border for the center
    pivot:      '#5B7B6A',   // Sage green ÔÇö earthy, calming
    entry:      '#D4917A',   // Warm coral-peach ÔÇö complements terracotta
    insight:    '#C4A265',   // Golden amber ÔÇö warm, luminous
    growth:     '#7BAF96',   // Eucalyptus green ÔÇö fresh, alive
  ...
  return (
    <View style={{ width: 300, height: 320, alignItems: 'center', justifyContent: 'center', marginVertical: 16 }}>
      ...
      {/* ENTRY ÔÇö top-right, warm coral */}
      ...
      {/* INSIGHT ÔÇö bottom-left, golden amber */}
      ...
      {/* GROWTH ÔÇö bottom-right, eucalyptus green */}
      ...
      <View style={{
        ...
        <View style={{
          ...
          {/* Inner constellation dots ÔÇö warm cream */}
      ...
      <View style={{ alignItems: 'center', zIndex: 1 }}>
        ...
        <StaggerItem index={2}>
          <Text style={[s.body, { marginBottom: 24, color: L.navySoft, textAlign: 'center', maxWidth: '90%' }]}>
            Every contributed journey helps someone else facing similar uncertainty ÔÇö one founder's pivot helps another avoid the same mistake, one student's internship prep guides hundreds. As more verified journeys are added, the graph gets richer and recommendations get stronger for everyone.
          </Text>
        </StaggerItem>
        <StaggerItem index={3}>
          <GraphMotif />
...
const LANG_CHIPS = ['Óñ╣Óñ┐Óñ¿ÓÑìÓñªÓÑÇ', 'Ó«ñÓ««Ó«┐Ó«┤Ó»ì', 'Ó░ñÓ▒åÓ░▓Ó▒üÓ░ùÓ▒ü', 'Óª¼Óª¥ÓªéÓª▓Óª¥', 'Óñ«Óñ░Óñ¥ÓñáÓÑÇ'];
    ...
    <SectionReveal style={{ backgroundColor: UI.surfaceInverse, paddingVertical: 80, paddingHorizontal: 24, alignItems: 'stretch' }}>
      ...
      <StaggerItem index={3}>
        <Text style={{ fontSize: 16, color: 'rgba(255,255,255,0.60)', textAlign: 'center', lineHeight: 26, maxWidth: '90%', alignSelf: 'center', fontFamily: 'Manrope_400Regular' }}>
          PathFinder is building a living repository of verified human journeys ÔÇö not to tell people what they should do, but to help them understand what others did, why, and what they learned. The more journeys the community contributes, the more valuable it becomes for everyone.
        </Text>
      </StaggerItem>
