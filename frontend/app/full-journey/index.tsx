...
import { ExpandableGoalCard, ExpandableExperienceCard } from './expandables';
...
export default function FullJourneyPage() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: L.background }}>
      {/* Header */}
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 16, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: L.border, backgroundColor: L.background }}>
        <TouchableOpacity onPress={() => router.back()} style={{ marginRight: 16 }}>
          <Feather name="chevron-left" size={24} color={L.navy} />
        </TouchableOpacity>
        <View style={{ flex: 1 }}>
